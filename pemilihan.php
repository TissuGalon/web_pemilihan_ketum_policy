            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card" style="cursor: pointer;" onclick="pilihKandidat(${kandidat.id}, '${kandidat.name}')">
                        <img src="proses/uploads/${kandidat.photo}" class="card-img-top" alt="${kandidat.name}" style="overflow:hidden; height:100;">
                        <div class="card-body text-center">
                            <h5 class="card-title">${kandidat.name}</h5>
                        </div>
                    </div>
                `;
                    ...
                    <div class="row">
                        <div class="col fs-13 text-muted text-center">
                            ...
                            <script>document.write(new Date().getFullYear())</script> - Made with <span
                                ...
                                class="text-reset fw-semibold">itsprzvl</a>
                        </div>
                    </div>
                </div>
            </footer>
